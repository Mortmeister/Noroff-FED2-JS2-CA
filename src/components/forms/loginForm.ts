export function loginForm(): string {
  return `     <div class="flex flex-col justify-center items-center">
      ...
      <div class="">
        <form action="#" class="space-y-6">
          <div>
            <label class="input validator">
              ...
              <input type="email" placeholder="@stud.noroff.no" name="email" required />
            </label>
          ...
          <div>
            <button
              type="submit"
              class="btn btn btn-soft btn-primary btn-xs sm:btn-sm md:btn-md lg:btn-lg"
              id="loginBtn"
            >
              Sign in
            </button>
        ...
        <p class="">
          Not a member?
          <a href="./register.html" class="">Register new user</a>
        </p>
      </div>
    </div>`;
}
